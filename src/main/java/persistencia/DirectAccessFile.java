...
/**
 * Una clase para representar un archivo binario de registros de longitud fija, con acceso 
 * directo. Un DirectAccessFile es un RegisterFile manejado para suponer que el archivo es 
...
public class DirectAccessFile extends RegisterFile
{
    ...
    // Para referir al objeto que implementará el método de ordenamiento que se
    // prefiera, según el patrón Strategy.
